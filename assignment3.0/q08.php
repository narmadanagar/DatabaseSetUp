...
include "top.php";
    ...
    $query = 'SELECT T.fldFirstName, T.fldLastName,  count(S.fldFirstName) as total, T.fldSalary, T.fldSalary/count(S.fldFirstName) as IBB
...
ORDER BY IBB asc';
    $info2 = $thisDatabaseReader->testquery($query, "", 0, 1, 2, 0, false, false);
