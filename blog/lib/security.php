...
function securityCheck($path_parts, $yourURL, $form = false) {
    ...
    $whiteListPages[] = "blogMembers.php";
    $whiteListPages[] = "tables.php";
    $whiteListPages[] = "posts.php";
    $whiteListPages[] = "form.php";
    $whiteListPages[] = "likes.php";
    $whiteListPages[] = "form2.php";
    $whiteListPages[] = "form3.php";
    $whiteListPages[] = "tryme.php";
    $whiteListPages[] = "blogPosts.php";
        $whiteListPages[] = "best.php";
                $whiteListPages[] = "quotes.php";
    ...
    $whiteListFolders[] = "/cs148develop/blog";
    $whiteListFolders[] = "/cs148/blog";
    $whiteListFolders[] = "/cs148develop/assignment3.0";
